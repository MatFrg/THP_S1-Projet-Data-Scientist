...
def question1(journalist)
	puts "Combien y a-t-il de journalistes dans ce array ?"
	puts journalist.length #379
end



def question2(journalist)
	puts "Combien d'handle contiennent un numéro ?"
	puts journalist.grep(/\d/).length #17 
end
...
def question4(journalist)
	puts "#Combien commencent par une majuscule (première lettre juste après le @) ?"
	puts journalist.grep(/@\p{Uppercase}/).length #209
end



def question5(journalist)
	puts "#Combien contiennent une majuscule ?"
	puts journalist.grep(/\p{Uppercase}/).length #215
end

 

def question6(journalist)
	puts "#Combien y a-t-il de underscore _ dans tous les pseudos confondus"
	puts journalist.grep(/_/).length #72
end



def question7(journalist)
...
def question8(journalist)
	puts"#Quels sont les 50 handles les plus courts de ce array ?"
	puts journalist.sort_by(&:length)[0..49]
end



def question9(journalist)
	puts "#Quelle est la position dans l'array de la personne @epenser"
	puts journalist.index('@epenser') #371
end


def reponse(journalist)
	question1(journalist)
	question2(journalist)
	question3(journalist)
	question4(journalist)
	question5(journalist)
	question6(journalist)
	question7(journalist)
	question8(journalist)
	question9(journalist)
end
